...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { description: @level.description, question_limit: @level.question_limit, question_score: @level.question_score, title: @level.title }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { description: @level.description, question_limit: @level.question_limit, question_score: @level.question_score, title: @level.title }
    assert_redirected_to level_path(assigns(:level))
  end
